 ...
 * 客户
 */
export const URL_LIST_HEAD = '/crm/customer/hybrid/listHeaderApi';              // 筛选条件
export const URL_CUSTOMER_LIST = '/crm/customer/hybrid/dataListApi';            // 客户列表
export const URL_CUSTOMER_DETAIL_VIEW = '/crm/customer/hybrid/viewApi';         // 客户详情页
