<template>
    <div class="view-monthly-dept flex-cloumn">
        ...
        <div v-if="isCustomerDataGet" class="flex-1 text-l" style="100%;overflow:auto">
            <div v-for="item in deptProductList" class="cnt-item" @click="jump(`/chart/monthlyplanman?deptids=${item.deptids}&deptcode=${item.deptcode}&plantime=${plantime}`)">
        ...
        <RightFilterDepartment :departmentList="departmentList"
         ...
         <div v-if="isCustomerDataGet&&deptProductList.length===0" style="position:absolute;margin-top:160px;left:50%;margin-left:-60px;color:#BEBEBE;text-align:center">
...
<script>
import RightFilterDepartment from '../../components/Chart/RightFilterDepartment';
import { mapActions } from 'vuex';
import { Spinner, Flexbox, FlexboxItem } from 'vux';
import { URL_REPORT_ACHIEVE_DEPARTMENT } from '../../constant/url';
import http from '../../http';

export default {
    name: 'monthlyPlanDept',
    components: {
        RightFilterDepartment,
        Spinner,
        Flexbox,
        FlexboxItem
    },
    ...
    methods: {
        ...
        getAchievementData () {
            ...
            http.post(URL_REPORT_ACHIEVE_DEPARTMENT, {
            ...
            .then((res) => {
                ...
                this.deptProductList = res.deptProductList;
